            ...
            {trackList.map((item, index) => (
                <div key={index} className='bg-[#fff] max-w-[440px] min-w-[320px] min-h-[300px] p-3 pb-5 flex flex-col items-start rounded-[14px] mx-3 my-[30px] shadow-custom '>
                    ...
                    <div className='flex w-full justify-between items-center' > 
                        <h3 className='text-[#ACACAC] font-[500] text-[0.9rem] ' >{item.category} </h3>
                        <span>stars</span>

                    </div>
                    <h2 className='text-[#000000] font-[500] text-[1.1rem] ' >{item.heading} </h2>
                    <h2 className='text-[#FF7426] font-[500] text-[1.1rem] '>${item.fee} </h2>
                    <div class="border-t-2 border-dotted border-gray-300 w-full my-4"></div>

                    <div className='flex flex-row gap-4 my-1' >
                        <h3  className='text-[#ACACAC] font-[500] text-[0.9rem] flex flex-row items-center gap-2 '><FaClock className='text-[#000] font-[300] ' />{item.duration.hours} hr {item.duration.minutes} min </h3>




                        
                        <h3  className='text-[#ACACAC] font-[500] text-[0.9rem] flex flex-row items-center gap-2   '><FaVideo className='text-[#000] font-[300]' /> {item.courses} courses </h3>
                        <h3  className='text-[#ACACAC] font-[500] text-[0.9rem] flex flex-row items-center gap-2 '><FaDownload className='text-[#000] font-[300]'/> {item.sales} sales </h3>
                    </div>
                    <button className='text-[#fff] font-[500] text-[1.1rem] rounded-[96px] bg-[#FF7426] font-Roboto px-4 py-3 min-w-[180px] self-center mb-[-40px]  mt-[6%]' >Join Course</button>
